# 1 "d:\\cource\\stream_1\\examples\\scripts\\uc3_find_flights\\\\combined_UC3_Find_flights.c"
...
# 1 "d:\\cource\\stream_1\\examples\\scripts\\uc3_find_flights\\\\combined_UC3_Find_flights.c" 2
...
# 2 "d:\\cource\\stream_1\\examples\\scripts\\uc3_find_flights\\\\combined_UC3_Find_flights.c" 2
...
# 3 "d:\\cource\\stream_1\\examples\\scripts\\uc3_find_flights\\\\combined_UC3_Find_flights.c" 2
...
# 4 "d:\\cource\\stream_1\\examples\\scripts\\uc3_find_flights\\\\combined_UC3_Find_flights.c" 2

# 1 "Action.c" 1
Action()
{
   lr_start_transaction("UC3_Find_flights");
	...
	web_custom_request("login.pl", 
		...
		"Snapshot=t6.inf", 
		"Mode=HTTP", 
		"Body=userSession={userSession}&username={login}&password={password}&login.x=41&login.y=10&JSFormSubmit=off", 
		"LAST");
	...
	web_custom_request("reservations.pl_2", 
		...
		"Snapshot=t12.inf", 
		"Mode=HTTP", 
		"Body=advanceDiscount=0&depart={depart}&departDate={departDate}&arrive={arrive}&returnDate={returnDate}&numPassengers=1&seatPref={seatPref}&seatType={seatType}&findFlights.x=35&findFlights.y=11&.cgifields=roundtrip&.cgifields=seatType&.cgifields=seatPref", 
		"LAST");

	lr_end_transaction("find_flight",2);
	
    lr_end_transaction("UC3_Find_flights", 2);

	return 0;
}
# 5 "d:\\cource\\stream_1\\examples\\scripts\\uc3_find_flights\\\\combined_UC3_Find_flights.c" 2
...
# 6 "d:\\cource\\stream_1\\examples\\scripts\\uc3_find_flights\\\\combined_UC3_Find_flights.c" 2
