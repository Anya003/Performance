Action()
{
	...
	web_custom_request("login.pl_2", 
		...
		"Snapshot=t8.inf", 
		"Mode=HTTP", 
		"Body=username=Rachel&password=fashionista&passwordConfirm=fashionista&firstName=Rachel&lastName=Green&address1=New+York&address2=11201&register.x=47&register.y=11", 
		LAST);
